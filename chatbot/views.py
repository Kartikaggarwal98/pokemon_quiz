...
PAGE_ACCESS_TOKEN = 'EAAQV8CvS4pUBAEu2lnYHxYx7MwNZBt9KT8a0LrBEYmXLxPdac0fswM5m4Co0ytMXyC7206KA0ra6ZCU1nqMJHDj2uBRAPoNDa3rA52gDuXTit1fcsLEseHszW8G3VgU3lDYUICeZArbFquyR5Y4F6Y1VnZAZBs3SrCZCcIoZCkRyjwVpFVPRiCz'
...
def post_facebook_message(fbid,message_text):
	...
	# response_msg_image={"recipient":{"id":fbid},"message":{"attachment":{"type":"template","payload":{"template_type":"generic","elements":[{"title":"color","subtitle":matching_color['colour_name'][1:]"image_url":image_url,"buttons":[{"type":"element_share"}]}]}}}}
